...
class DistributorOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.distributorOrders.index', compact('distributorOrders'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.distributorOrders.create', compact('distributors', 'orders'));
    }
    ...
    public function store(StoreDistributorOrderRequest $request)
    {
        ...
        return redirect()->route('frontend.distributor-orders.index');
    }
    ...
    public function edit(DistributorOrder $distributorOrder)
    {
        ...
        return view('frontend.distributorOrders.edit', compact('distributorOrder', 'distributors', 'orders'));
    }
    ...
    public function show(DistributorOrder $distributorOrder)
    {
        ...
        return view('frontend.distributorOrders.show', compact('distributorOrder'));
    }
