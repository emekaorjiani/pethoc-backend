...
class SalesTransactionsHistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.salesTransactionsHistories.index', compact('salesTransactionsHistories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.salesTransactionsHistories.create', compact('products', 'stations'));
    }
    ...
    public function store(StoreSalesTransactionsHistoryRequest $request)
    {
        ...
        return redirect()->route('frontend.sales-transactions-histories.index');
    }
    ...
    public function edit(SalesTransactionsHistory $salesTransactionsHistory)
    {
        ...
        return view('frontend.salesTransactionsHistories.edit', compact('products', 'salesTransactionsHistory', 'stations'));
    }
    ...
    public function show(SalesTransactionsHistory $salesTransactionsHistory)
    {
        ...
        return view('frontend.salesTransactionsHistories.show', compact('salesTransactionsHistory'));
    }
