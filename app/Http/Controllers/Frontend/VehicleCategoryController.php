...
class VehicleCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.vehicleCategories.index', compact('vehicleCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.vehicleCategories.create');
    }
    ...
    public function store(StoreVehicleCategoryRequest $request)
    {
        ...
        return redirect()->route('frontend.vehicle-categories.index');
    }
    ...
    public function edit(VehicleCategory $vehicleCategory)
    {
        ...
        return view('frontend.vehicleCategories.edit', compact('vehicleCategory'));
    }
    ...
    public function show(VehicleCategory $vehicleCategory)
    {
        ...
        return view('frontend.vehicleCategories.show', compact('vehicleCategory'));
    }
