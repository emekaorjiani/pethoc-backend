...
class PumpTransactionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.pumpTransactions.index', compact('pumpTransactions'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.pumpTransactions.create', compact('stations'));
    }
    ...
    public function store(StorePumpTransactionRequest $request)
    {
        ...
        return redirect()->route('frontend.pump-transactions.index');
    }
    ...
    public function edit(PumpTransaction $pumpTransaction)
    {
        ...
        return view('frontend.pumpTransactions.edit', compact('pumpTransaction', 'stations'));
    }
    ...
    public function show(PumpTransaction $pumpTransaction)
    {
        ...
        return view('frontend.pumpTransactions.show', compact('pumpTransaction'));
    }
