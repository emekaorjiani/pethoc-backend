...
class GasInfoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.gasInfos.index', compact('gasInfos'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.gasInfos.create', compact('users'));
    }
    ...
    public function store(StoreGasInfoRequest $request)
    {
        ...
        return redirect()->route('admin.gas-infos.index');
    }
    ...
    public function edit(GasInfo $gasInfo)
    {
        ...
        return view('admin.gasInfos.edit', compact('gasInfo', 'users'));
    }
    ...
    public function show(GasInfo $gasInfo)
    {
        ...
        return view('admin.gasInfos.show', compact('gasInfo'));
    }
