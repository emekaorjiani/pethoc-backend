...
class OrderTrackingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.orderTrackings.index', compact('orderTrackings'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.orderTrackings.create', compact('orders'));
    }
    ...
    public function store(StoreOrderTrackingRequest $request)
    {
        ...
        return redirect()->route('admin.order-trackings.index');
    }
    ...
    public function edit(OrderTracking $orderTracking)
    {
        ...
        return view('admin.orderTrackings.edit', compact('orderTracking', 'orders'));
    }
