...
class FuelPurchaseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.fuelPurchases.index', compact('fuelPurchases'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.fuelPurchases.create', compact('products', 'users'));
    }
    ...
    public function store(StoreFuelPurchaseRequest $request)
    {
        ...
        return redirect()->route('admin.fuel-purchases.index');
    }
    ...
    public function edit(FuelPurchase $fuelPurchase)
    {
        ...
        return view('admin.fuelPurchases.edit', compact('fuelPurchase', 'products', 'users'));
    }
    ...
    public function show(FuelPurchase $fuelPurchase)
    {
        ...
        return view('admin.fuelPurchases.show', compact('fuelPurchase'));
    }
