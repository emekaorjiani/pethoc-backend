...
class StationAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.stationAdmins.index', compact('stationAdmins'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.stationAdmins.create', compact('stations', 'users'));
    }
    ...
    public function store(StoreStationAdminRequest $request)
    {
        ...
        return redirect()->route('admin.station-admins.index');
    }
    ...
    public function edit(StationAdmin $stationAdmin)
    {
        ...
        return view('admin.stationAdmins.edit', compact('stationAdmin', 'stations', 'users'));
    }
    ...
    public function show(StationAdmin $stationAdmin)
    {
        ...
        return view('admin.stationAdmins.show', compact('stationAdmin'));
    }
