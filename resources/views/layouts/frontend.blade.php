                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('wallet_transaction_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.wallet-transactions.index') }}">
                                            {{ trans('cruds.walletTransaction.title') }}
                                        </a>
                                    @endcan
                                    @can('pet_wallet_transaction_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pet-wallet-transactions.index') }}">
                                            {{ trans('cruds.petWalletTransaction.title') }}
                                        </a>
                                    @endcan
                                    @can('pump_transaction_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pump-transactions.index') }}">
                                            {{ trans('cruds.pumpTransaction.title') }}
                                        </a>
                                    @endcan
                                    @can('sales_transactions_history_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.sales-transactions-histories.index') }}">
                                    ...
                                    @can('distributor_order_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.distributor-orders.index') }}">
                                    ...
                                    @can('station_management_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.station-managements.index') }}">
                                    ...
                                    @can('vehicle_category_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.vehicle-categories.index') }}">
