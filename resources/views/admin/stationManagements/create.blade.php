    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.station-managements.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_of_pumps') ? 'is-invalid' : '' }}" type="number" name="number_of_pumps" id="number_of_pumps" value="{{ old('number_of_pumps', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_types') ? 'is-invalid' : '' }}" type="text" name="product_types" id="product_types" value="{{ old('product_types', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prices') ? 'is-invalid' : '' }}" type="text" name="prices" id="prices" value="{{ old('prices', '') }}" required>
