    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pickup_area') ? 'is-invalid' : '' }}" type="text" name="pickup_area" id="pickup_area" value="{{ old('pickup_area', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_location') ? 'is-invalid' : '' }}" type="text" name="delivery_location" id="delivery_location" value="{{ old('delivery_location', '') }}" required>
