    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicles.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('is_avaliable') ? 'is-invalid' : '' }}" type="number" name="is_avaliable" id="is_avaliable" value="{{ old('is_avaliable', '1') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_location') ? 'is-invalid' : '' }}" type="text" name="current_location" id="current_location" value="{{ old('current_location', '') }}">
