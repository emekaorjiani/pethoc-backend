...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.gas-infos.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('gas_level') ? 'is-invalid' : '' }}" type="number" name="gas_level" id="gas_level" value="{{ old('gas_level', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('low_level_notification_enabled') ? 'is-invalid' : '' }}" type="text" name="low_level_notification_enabled" id="low_level_notification_enabled" value="{{ old('low_level_notification_enabled', 'true') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auto_refill_enabled') ? 'is-invalid' : '' }}" type="text" name="auto_refill_enabled" id="auto_refill_enabled" value="{{ old('auto_refill_enabled', 'false') }}" required>
