    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.distributors.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('profile_info') ? 'is-invalid' : '' }}" type="text" name="profile_info" id="profile_info" value="{{ old('profile_info', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kyc_verified') ? 'is-invalid' : '' }}" type="text" name="kyc_verified" id="kyc_verified" value="{{ old('kyc_verified', 'false') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', 'active') }}" required>
