                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payments.update", [$payment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $payment->payment_method) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_provider" id="payment_provider" value="{{ old('payment_provider', $payment->payment_provider) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_code" id="payment_code" value="{{ old('payment_code', $payment->payment_code) }}">
