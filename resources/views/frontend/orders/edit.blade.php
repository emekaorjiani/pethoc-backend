                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.orders.update", [$order->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pickup_area" id="pickup_area" value="{{ old('pickup_area', $order->pickup_area) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="delivery_phone" id="delivery_phone" value="{{ old('delivery_phone', $order->delivery_phone) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="delivery_location" id="delivery_location" value="{{ old('delivery_location', $order->delivery_location) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="payment_method" id="payment_method" value="{{ old('payment_method', $order->payment_method) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $order->total_cost) }}" step="0.01" required>
