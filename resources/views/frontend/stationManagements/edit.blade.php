    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.station-managements.update", [$stationManagement->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="number_of_pumps">{{ trans('cruds.stationManagement.fields.number_of_pumps') }}</label>
                            <input class="form-control" type="number" name="number_of_pumps" id="number_of_pumps" value="{{ old('number_of_pumps', $stationManagement->number_of_pumps) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="product_types" id="product_types" value="{{ old('product_types', $stationManagement->product_types) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="prices" id="prices" value="{{ old('prices', $stationManagement->prices) }}" required>
