    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.gas-infos.update", [$gasInfo->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="gas_level" id="gas_level" value="{{ old('gas_level', $gasInfo->gas_level) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="low_level_notification_enabled" id="low_level_notification_enabled" value="{{ old('low_level_notification_enabled', $gasInfo->low_level_notification_enabled) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_refill_enabled" id="auto_refill_enabled" value="{{ old('auto_refill_enabled', $gasInfo->auto_refill_enabled) }}" required>
