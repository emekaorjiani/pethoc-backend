                        ...
                        <table class=" table table-bordered table-striped table-hover datatable datatable-User">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        {{ trans('cruds.user.fields.avatar_image') }}
                                    </th>
                                    <th>
                                    ...
                                    <th>
                                        {{ trans('cruds.user.fields.wallet_balance') }}
                                    </th>
                                    <th>
                                    ...
                                    <tr data-entry-id="{{ $user->id }}">
                                        ...
                                        <td>
                                            @if($user->avatar_image)
                                                <a href="{{ $user->avatar_image->getUrl() }}" target="_blank" style="display: inline-block">
                                                    <img src="{{ $user->avatar_image->getUrl('thumb') }}">
                                                </a>
                                            @endif
                                        </td>
                                        <td>
