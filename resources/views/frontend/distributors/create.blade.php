    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.distributors.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="profile_info" id="profile_info" value="{{ old('profile_info', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="kyc_verified" id="kyc_verified" value="{{ old('kyc_verified', 'false') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="status" id="status" value="{{ old('status', 'active') }}" required>
